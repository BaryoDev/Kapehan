...
| Type declarations | 7 `.d.ts` covering the 8 code subpaths, generated by `scripts/generators/types.mjs`. The other 5 exports are a stylesheet, two SVG wildcards and `palettes.json`, which needs no declaration. |
